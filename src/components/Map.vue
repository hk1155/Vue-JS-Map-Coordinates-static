<template>
    <div>
        ...
        <p>{{coordinates.lat}} Latitude, {{coordinates.lng}} Longtitude</p><hr>

        <h4>Custom Coordinates</h4>
        <p>{{dclat}} Latitude, {{dclng}} Longtitude</p><hr>
        <h4>Map Coordinates</h4>
        <p>{{mapdata.lat}} Latitude, {{mapdata.lng}} Longtitude</p><hr>
        <input type="text" v-model="cust.clat" placeholder="latitude">
        <input type="text" v-model="cust.clng" placeholder="longtitude">
        <button v-on:click="getData">Click</button><hr>
             <GmapMap
            :center=coordinates
            :zoom="7"
            map-type-id="terrain"
